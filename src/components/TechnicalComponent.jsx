...
import css from "../styles/technical-style.css";
const Technical = ({technical}) => (
		<div className={"mdl-card mdl-shadow--2dp "+ css["parent"]}>
			<div className="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
				<div className="mdl-tabs__tab-bar">
					<a href="#languages-panel" className="mdl-tabs__tab is-active">Languages</a>
					<a href="#databases-panel" className="mdl-tabs__tab">Databases</a>
					<a href="#frameworks-panel" className="mdl-tabs__tab">frameworks</a>
				</div>
